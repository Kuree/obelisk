...
ABI_FUNCTION(obelisk_rt_v1_random_solve,
             obelisk_rt_status (*)(obelisk_rt_context *, const uint8_t *,
                                   ...
                                   uint32_t *));
ABI_FUNCTION(obelisk_rt_v1_random_solve_masked,
             obelisk_rt_status (*)(obelisk_rt_context *, const uint8_t *,
                                   uint64_t, uint64_t, uint64_t, uint64_t,
                                   const uint64_t *, uint64_t, uint64_t *,
                                   uint32_t *));
ABI_FUNCTION(obelisk_rt_v1_random_solve_modes,
             obelisk_rt_status (*)(obelisk_rt_context *, const uint8_t *,
                                   uint64_t, uint64_t, uint64_t, uint64_t,
                                   uint64_t, const uint64_t *, uint64_t,
                                   uint64_t *, uint32_t *));
ABI_FUNCTION(obelisk_rt_v1_random_solve_modes_state,
             obelisk_rt_status (*)(obelisk_rt_context *, const uint8_t *,
                                   uint64_t, uint64_t, uint64_t, uint64_t,
                                   uint64_t, uint64_t, uint64_t,
                                   const uint64_t *, uint64_t, uint64_t *,
                                   uint32_t *, uint64_t *));
ABI_FUNCTION(obelisk_rt_v1_random_solve_wide_modes_state,
             obelisk_rt_status (*)(obelisk_rt_context *, const uint8_t *,
...
ABI_FUNCTION(obelisk_rt_v1_assertion_action_state,
             uint32_t (*)(obelisk_rt_context *, uint64_t));
ABI_FUNCTION(obelisk_rt_v1_assertion_kill_epoch,
...
ABI_FUNCTION(obelisk_rt_v1_scheduler_finish,
             obelisk_rt_status (*)(obelisk_rt_context *, uint32_t));
ABI_FUNCTION(obelisk_rt_v1_scheduler_stop,
             obelisk_rt_status (*)(obelisk_rt_context *, uint32_t));
...
ABI_FUNCTION(obelisk_rt_v1_scheduler_handoff_periodic_aot,
             obelisk_rt_status (*)(obelisk_rt_context *,
                                   const obelisk_rt_native_periodic_clock_v1 *,
...
ABI_FUNCTION(obelisk_rt_v1_scheduler_process_token,
             uint64_t (*)(obelisk_rt_context *,
                          obelisk_rt_process_instance_v1 *));
ABI_FUNCTION(obelisk_rt_v1_process_current, uint64_t (*)(obelisk_rt_context *));
...
ABI_FUNCTION(obelisk_rt_v1_native_state_alloc_with_roots,
             obelisk_rt_status (*)(obelisk_rt_context *, uint64_t,
                                   const uint8_t *, const uint8_t *,
                                   const uint64_t *, uint64_t, uint64_t *));
ABI_FUNCTION(obelisk_rt_v1_native_state_alloc_with_typed_roots,
             obelisk_rt_status (*)(obelisk_rt_context *, uint64_t,
                                   const uint8_t *, const uint8_t *,
                                   const obelisk_rt_managed_root_slot_v1 *,
                                   uint64_t, uint64_t *));
...
ABI_FUNCTION(obelisk_rt_v1_gc_managed_root_range_pop,
             obelisk_rt_status (*)(obelisk_rt_gc_lane_v1 *,
                                   obelisk_rt_gc_managed_root_range_v1 *));
ABI_FUNCTION(obelisk_rt_v1_gc_candidate_root,
             obelisk_rt_managed_word_v1 (*)(
                 obelisk_rt_context *, obelisk_rt_managed_word_v1,
                 obelisk_rt_managed_root_kind_mask_v1));
...
ABI_FUNCTION(obelisk_rt_v1_gc_static_root_register,
             obelisk_rt_status (*)(obelisk_rt_context *,
                                   obelisk_rt_object_v1 **));
ABI_FUNCTION(obelisk_rt_v1_gc_candidate_static_root_register,
             obelisk_rt_status (*)(obelisk_rt_context *,
                                   obelisk_rt_managed_word_v1 *,
                                   obelisk_rt_managed_root_kind_mask_v1));
...
ABI_FUNCTION(obelisk_rt_v1_object_read,
             obelisk_rt_status (*)(obelisk_rt_object_v1 *, uint64_t, void *,
                                   uint64_t));
ABI_FUNCTION(obelisk_rt_v1_gc_design_candidate_root_register,
             obelisk_rt_status (*)(obelisk_rt_context *, uint64_t,
                                   obelisk_rt_managed_root_kind_mask_v1));
...
ABI_FUNCTION(obelisk_rt_v1_mailbox_try_put,
             obelisk_rt_status (*)(obelisk_rt_gc_lane_v1 *,
                                   ...
                                   const void *, uint32_t *));
ABI_FUNCTION(obelisk_rt_v1_mailbox_try_put_checked,
             obelisk_rt_status (*)(obelisk_rt_gc_lane_v1 *,
                                   obelisk_rt_object_v1 *, const void *,
...
ABI_FUNCTION(obelisk_rt_v1_mailbox_try_peek,
             obelisk_rt_status (*)(obelisk_rt_object_v1 *, void *, void *,
                                   uint32_t *));
ABI_FUNCTION(obelisk_rt_v1_mailbox_try_peek_checked,
             obelisk_rt_status (*)(obelisk_rt_object_v1 *, void *, uint64_t,
                                   void *, uint64_t, uint32_t *));
ABI_FUNCTION(obelisk_rt_v1_mailbox_try_get,
             obelisk_rt_status (*)(obelisk_rt_object_v1 *, void *, void *,
                                   uint32_t *));
ABI_FUNCTION(obelisk_rt_v1_mailbox_try_get_checked,
             obelisk_rt_status (*)(obelisk_rt_object_v1 *, void *, uint64_t,
                                   void *, uint64_t, uint32_t *));
...
ABI_FUNCTION(obelisk_rt_v1_interface_method_resolve,
             obelisk_rt_status (*)(obelisk_rt_object_v1 *, uint64_t, uint64_t,
                                   uint64_t,
                                   const obelisk_rt_method_descriptor_v1 **));
...
ABI_FUNCTION(obelisk_rt_v1_interface_method_invoke,
             obelisk_rt_status (*)(obelisk_rt_gc_lane_v1 *,
                                   obelisk_rt_object_v1 *, uint64_t, uint64_t,
                                   uint64_t,
                                   const obelisk_rt_method_argument_v1 *,
...
ABI_FUNCTION(obelisk_rt_v1_method_task_activate,
             obelisk_rt_status (*)(obelisk_rt_gc_lane_v1 *,
                                   ...
                                   const obelisk_rt_method_argument_v1 *,
                                   uint32_t, uint64_t *));
ABI_FUNCTION(obelisk_rt_v1_interface_method_task_activate,
             obelisk_rt_status (*)(obelisk_rt_gc_lane_v1 *,
                                   obelisk_rt_object_v1 *, uint64_t, uint64_t,
                                   uint64_t,
                                   const obelisk_rt_method_argument_v1 *,
