...
void populateManagedContainerToLLVMConversionPatterns(
  ...
  patterns.add<
      ...
      ContainerWriteConversion, AssocCreateConversion,
      AssocReadConversion, AssocWriteConversion,
      AssocDefaultConversion, AssocExistsConversion,
      AssocDeleteConversion, AssocTraverseConversion,
      RandomNextConversion, RandomSeedConversion,
