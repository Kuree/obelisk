...
constexpr uint32_t kIntrinsicAssertionKillEpoch =
    OBELISK_RT_INTRINSIC_V1_ASSERTION_KILL_EPOCH;
...
constexpr uint32_t kIntrinsicDumpPorts = OBELISK_RT_INTRINSIC_V1_DUMP_PORTS;
constexpr uint32_t kIntrinsicDumpPortsControl =
    OBELISK_RT_INTRINSIC_V1_DUMP_PORTS_CONTROL;
