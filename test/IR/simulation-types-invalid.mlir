...
// expected-error @+1 {{element type must be a signless builtin integer or !obelisk_sim.logic, got 'f32'}}
func.func private @ref_of_float(%arg: !obelisk_sim.ref<f32>)

// -----

// expected-error @+1 {{element type must be a signless builtin integer or !obelisk_sim.logic, got '!obelisk_sim.time'}}
...
// expected-error @+1 {{element type must be a signless builtin integer or !obelisk_sim.logic, got '!obelisk_sim.ref<i8>'}}
