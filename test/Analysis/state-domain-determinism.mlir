...
module {
  ...
  obelisk_sim.design @zeta {
    obelisk_sim.code_unit.decl 9000001 in 0 initial hierarchy "test.zeta.worker.9000001"
  ...
  obelisk_sim.design @alpha {
    obelisk_sim.code_unit.decl 9000001 in 0 initial hierarchy "test.alpha.worker.9000001"
    obelisk_sim.scope.decl 0
    obelisk_sim.func @worker(
        %ctx: !obelisk_sim.context {obelisk_sim.capture_kind = 0 : i32})
        attributes {entry_kind = 1 : i32, code_unit_id = 9000001 : i64} {
