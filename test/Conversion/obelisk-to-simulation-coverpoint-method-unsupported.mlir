  ...
  obelisk.sv.symbol.root attributes {hierarchical_name = "\\$root ", name = "$root", node_id = 1 : i64, sym_name = "s1.$root"} {
    ...
    obelisk.sv.symbol.instance attributes {hierarchical_name = "covergroup_unsupported", is_uninstantiated = false, name = "covergroup_unsupported", node_id = 3 : i64, referenced_path = "covergroup_unsupported", referenced_symbol = @s0.covergroup_unsupported, sym_name = "s3.covergroup_unsupported"} {
      obelisk.sv.symbol.instance_body attributes {hierarchical_name = "covergroup_unsupported", name = "covergroup_unsupported", node_id = 4 : i64, sym_name = "s4.covergroup_unsupported"} {
        ...
        obelisk.sv.symbol.procedural_block attributes {hierarchical_name = "covergroup_unsupported", node_id = 58 : i64, procedure_kind = 0 : i32, sym_name = "s36", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
          obelisk.sv.statement.block attributes {node_id = 59 : i64} {
            obelisk.sv.statement.list attributes {node_id = 60 : i64} {
              obelisk.sv.statement.expression_statement attributes {node_id = 61 : i64} {
                obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, node_id = 62 : i64, semantic_type = !obelisk.covergroup_handle<@s1.$root::@s4.covergroup_unsupported::@s8.cg>} {
                  obelisk.sv.expression.named_value attributes {node_id = 63 : i64, referenced_path = "covergroup_unsupported.c", referenced_symbol = @s1.$root::@s3.covergroup_unsupported::@s4.covergroup_unsupported::@s35.c, semantic_type = !obelisk.covergroup_handle<@s1.$root::@s4.covergroup_unsupported::@s8.cg>} {
                  }
                  obelisk.sv.expression.new_covergroup attributes {argument_count = 0 : i64, node_id = 64 : i64, semantic_type = !obelisk.covergroup_handle<@s1.$root::@s4.covergroup_unsupported::@s8.cg>} {
                  }
                }
              }
              obelisk.sv.statement.expression_statement attributes {node_id = 65 : i64} {
                obelisk.sv.expression.call attributes {argument_count = 2 : i64, callee_name = "$display", constraint_restrictions = [], defaulted_arguments = array<i64: 0, 0>, has_inline_constraints = false, has_iterator_expression = false, has_output_arguments = false, has_this_class = false, is_super_class = false, is_system_call = true, node_id = 66 : i64, semantic_type = !obelisk.void, subroutine_kind = 1 : i32, system_library_cell = "work.covergroup_unsupported", system_scope_path = "covergroup_unsupported", system_scope_symbol = @s1.$root::@s3.covergroup_unsupported::@s4.covergroup_unsupported} {
                  obelisk.sv.expression.string_literal attributes {constant_value = "%f", node_id = 67 : i64, semantic_type = !obelisk.ranged_packed_array<15 : 0 x !obelisk.integral<1, false, false, 0 : 0, bit>>} {
                  }
                  obelisk.sv.expression.call attributes {argument_count = 2 : i64, callee_name = "get_inst_coverage", constraint_restrictions = [], defaulted_arguments = array<i64: 1, 1>, has_inline_constraints = false, has_iterator_expression = false, has_output_arguments = true, has_this_class = true, is_super_class = false, is_system_call = false, node_id = 68 : i64, referenced_path = "covergroup_unsupported.cg.cp.get_inst_coverage", referenced_symbol = @s1.$root::@s3.covergroup_unsupported::@s4.covergroup_unsupported::@s8.cg::@s9::@s23.cp::@s29.get_inst_coverage, semantic_type = !obelisk.real, subroutine_kind = 0 : i32} {
                    obelisk.sv.expression.member_access attributes {field_ordinal = 2825111872 : i64, node_id = 69 : i64, packed_offset = 0 : i64, referenced_path = "covergroup_unsupported.cg.cp", referenced_symbol = @s1.$root::@s3.covergroup_unsupported::@s4.covergroup_unsupported::@s8.cg::@s9::@s23.cp, semantic_type = !obelisk.void} {
...
// CHECK: coverpoint methods are not supported
