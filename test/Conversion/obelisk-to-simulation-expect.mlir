              ...
              obelisk.sv.expression.assertion_instance attributes {argument_count = 0 : i64, argument_formal_paths = [], argument_formal_symbols = [], argument_kinds = array<i64>, has_expanded_body = true, is_recursive_property = false, local_variable_count = 0 : i64, local_variable_has_initializer = array<i64>, local_variable_paths = [], local_variable_symbols = [], node_id = 11 : i64, referenced_path = "expect_test.named_property", referenced_symbol = @s1.$root::@s3.expect_test::@s4.expect_test::@s7.named_property, semantic_type = !obelisk.property} {
                obelisk.sv.assertion.clocking attributes {node_id = 12 : i64} {
                  obelisk.sv.timing.signal_event attributes {edge_kind = 1 : i32, has_iff = false, node_id = 13 : i64} {
                    obelisk.sv.expression.named_value attributes {node_id = 14 : i64, referenced_path = "expect_test.enable", referenced_symbol = @s1.$root::@s3.expect_test::@s4.expect_test::@s6.enable, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                    }
                  }
                  obelisk.sv.assertion.sequence_concat attributes {delays = [{is_unbounded = false, max = 0 : i64, min = 0 : i64}, {is_unbounded = false, max = 1 : i64, min = 1 : i64}], node_id = 15 : i64} {
                    obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 16 : i64, repetition_is_unbounded = false} {
                      obelisk.sv.expression.named_value attributes {node_id = 17 : i64, referenced_path = "expect_test.enable", referenced_symbol = @s1.$root::@s3.expect_test::@s4.expect_test::@s6.enable, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                      }
                    }
                    obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 18 : i64, repetition_is_unbounded = false} {
                      obelisk.sv.expression.named_value attributes {node_id = 19 : i64, referenced_path = "expect_test.enable", referenced_symbol = @s1.$root::@s3.expect_test::@s4.expect_test::@s6.enable, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                      }
                    }
                  }
                }
