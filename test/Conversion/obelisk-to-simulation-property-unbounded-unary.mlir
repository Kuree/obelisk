  ...
  obelisk.sv.symbol.root attributes {hierarchical_name = "\\$root ", name = "$root", node_id = 1 : i64, sym_name = "s1.$root"} {
    ...
    obelisk.sv.symbol.instance attributes {hierarchical_name = "top", is_uninstantiated = false, name = "top", node_id = 3 : i64, referenced_path = "top", referenced_symbol = @s0.top, sym_name = "s3.top"} {
      obelisk.sv.symbol.instance_body attributes {hierarchical_name = "top", name = "top", node_id = 4 : i64, sym_name = "s4.top", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
        ...
        obelisk.sv.symbol.statement_block attributes {block_kind = 0 : i32, hierarchical_name = "top.aa", name = "aa", node_id = 11 : i64, sym_name = "s11.aa"} {
        }
        obelisk.sv.symbol.procedural_block attributes {hierarchical_name = "top", node_id = 12 : i64, procedure_kind = 2 : i32, sym_name = "s12", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
          obelisk.sv.statement.block attributes {block_path = "top.aa", block_symbol = @s1.$root::@s3.top::@s4.top::@s11.aa, node_id = 13 : i64} {
            obelisk.sv.statement.concurrent_assertion attributes {assertion_kind = 0 : i32, has_default_disable = false, has_fail_action = true, has_pass_action = true, node_id = 14 : i64} {
              obelisk.sv.assertion.clocking attributes {node_id = 15 : i64} {
                ...
                obelisk.sv.assertion.unary attributes {has_range = false, node_id = 18 : i64, operator_kind = 3 : i32, range_is_unbounded = false} {
              ...
              obelisk.sv.statement.expression_statement attributes {node_id = 24 : i64} {
                obelisk.sv.expression.call attributes {argument_count = 1 : i64, callee_name = "$display", constraint_restrictions = [], defaulted_arguments = array<i64: 0>, has_inline_constraints = false, has_iterator_expression = false, has_output_arguments = false, has_this_class = false, is_signed = false, is_super_class = false, is_system_call = true, node_id = 25 : i64, semantic_type = !obelisk.void, subroutine_kind = 1 : i32, system_library_cell = "work.top", system_scope_path = "top.aa", system_scope_symbol = @s1.$root::@s3.top::@s4.top::@s11.aa} {
                  obelisk.sv.expression.string_literal attributes {constant_value = "always-fail", is_signed = false, node_id = 26 : i64, semantic_type = !obelisk.ranged_packed_array<87 : 0 x !obelisk.integral<1, false, false, 0 : 0, bit>>} {
                  }
                }
              }
            }
        ...
        obelisk.sv.symbol.statement_block attributes {block_kind = 0 : i32, hierarchical_name = "top.ar", name = "ar", node_id = 27 : i64, sym_name = "s13.ar"} {
        }
        obelisk.sv.symbol.procedural_block attributes {hierarchical_name = "top", node_id = 28 : i64, procedure_kind = 2 : i32, sym_name = "s14", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
          obelisk.sv.statement.block attributes {block_path = "top.ar", block_symbol = @s1.$root::@s3.top::@s4.top::@s13.ar, node_id = 29 : i64} {
            obelisk.sv.statement.concurrent_assertion attributes {assertion_kind = 0 : i32, has_default_disable = false, has_fail_action = false, has_pass_action = true, node_id = 30 : i64} {
              obelisk.sv.assertion.clocking attributes {node_id = 31 : i64} {
                ...
                obelisk.sv.assertion.unary attributes {has_range = true, node_id = 34 : i64, operator_kind = 3 : i32, range_is_unbounded = true, range_min = 2 : i64} {
              ...
              obelisk.sv.statement.empty attributes {node_id = 37 : i64} {
              }
            }
          }
        }
        obelisk.sv.symbol.statement_block attributes {block_kind = 0 : i32, hierarchical_name = "top.ee", name = "ee", node_id = 38 : i64, sym_name = "s15.ee"} {
        }
        obelisk.sv.symbol.procedural_block attributes {hierarchical_name = "top", node_id = 39 : i64, procedure_kind = 2 : i32, sym_name = "s16", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
          obelisk.sv.statement.block attributes {block_path = "top.ee", block_symbol = @s1.$root::@s3.top::@s4.top::@s15.ee, node_id = 40 : i64} {
            obelisk.sv.statement.concurrent_assertion attributes {assertion_kind = 0 : i32, has_default_disable = false, has_fail_action = true, has_pass_action = true, node_id = 41 : i64} {
              obelisk.sv.assertion.clocking attributes {node_id = 42 : i64} {
                ...
                obelisk.sv.assertion.unary attributes {has_range = false, node_id = 45 : i64, operator_kind = 6 : i32, range_is_unbounded = false} {
                  obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 46 : i64, repetition_is_unbounded = false} {
                    obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 47 : i64, referenced_path = "top.b", referenced_symbol = @s1.$root::@s3.top::@s4.top::@s10.b, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                    }
                  }
                }
              }
              obelisk.sv.statement.expression_statement attributes {node_id = 48 : i64} {
                obelisk.sv.expression.call attributes {argument_count = 1 : i64, callee_name = "$display", constraint_restrictions = [], defaulted_arguments = array<i64: 0>, has_inline_constraints = false, has_iterator_expression = false, has_output_arguments = false, has_this_class = false, is_signed = false, is_super_class = false, is_system_call = true, node_id = 49 : i64, semantic_type = !obelisk.void, subroutine_kind = 1 : i32, system_library_cell = "work.top", system_scope_path = "top.ee", system_scope_symbol = @s1.$root::@s3.top::@s4.top::@s15.ee} {
                  obelisk.sv.expression.string_literal attributes {constant_value = "eventually-pass", is_signed = false, node_id = 50 : i64, semantic_type = !obelisk.ranged_packed_array<119 : 0 x !obelisk.integral<1, false, false, 0 : 0, bit>>} {
                  }
                }
              }
              obelisk.sv.statement.expression_statement attributes {node_id = 51 : i64} {
                obelisk.sv.expression.call attributes {argument_count = 1 : i64, callee_name = "$display", constraint_restrictions = [], defaulted_arguments = array<i64: 0>, has_inline_constraints = false, has_iterator_expression = false, has_output_arguments = false, has_this_class = false, is_signed = false, is_super_class = false, is_system_call = true, node_id = 52 : i64, semantic_type = !obelisk.void, subroutine_kind = 1 : i32, system_library_cell = "work.top", system_scope_path = "top.ee", system_scope_symbol = @s1.$root::@s3.top::@s4.top::@s15.ee} {
                  obelisk.sv.expression.string_literal attributes {constant_value = "eventually-fail", is_signed = false, node_id = 53 : i64, semantic_type = !obelisk.ranged_packed_array<119 : 0 x !obelisk.integral<1, false, false, 0 : 0, bit>>} {
                  }
                }
              }
            }
        ...
        obelisk.sv.symbol.statement_block attributes {block_kind = 0 : i32, hierarchical_name = "top.er", name = "er", node_id = 54 : i64, sym_name = "s17.er"} {
        }
        obelisk.sv.symbol.procedural_block attributes {hierarchical_name = "top", node_id = 55 : i64, procedure_kind = 2 : i32, sym_name = "s18", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
          obelisk.sv.statement.block attributes {block_path = "top.er", block_symbol = @s1.$root::@s3.top::@s4.top::@s17.er, node_id = 56 : i64} {
            obelisk.sv.statement.concurrent_assertion attributes {assertion_kind = 0 : i32, has_default_disable = false, has_fail_action = false, has_pass_action = true, node_id = 57 : i64} {
              obelisk.sv.assertion.clocking attributes {node_id = 58 : i64} {
                ...
                obelisk.sv.assertion.unary attributes {has_range = true, node_id = 61 : i64, operator_kind = 6 : i32, range_is_unbounded = true, range_min = 2 : i64} {
              ...
              obelisk.sv.statement.empty attributes {node_id = 64 : i64} {
              }
            }
          }
        }
