        ...
        obelisk.sv.type.covergroup_type attributes {constructor_argument_count = 0 : i64, has_coverage_event = true, hierarchical_name = "covergroup_unsupported.cg", name = "cg", node_id = 8 : i64, sample_formal_count = 0 : i64, semantic_type = !obelisk.covergroup_handle<@s1.$root::@s4.covergroup_unsupported::@s8.cg>, sym_name = "s8.cg"} {
          ...
          obelisk.sv.symbol.covergroup_body attributes {hierarchical_name = "covergroup_unsupported.cg", node_id = 11 : i64, option_count = 0 : i64, sym_name = "s9"} {
            ...
            obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.get_coverage", is_builtin, is_static, name = "get_coverage", node_id = 17 : i64, semantic_type = !obelisk.subroutine<(!obelisk.integral<32, true, false, 31 : 0, int>, !obelisk.integral<32, true, false, 31 : 0, int>) -> !obelisk.real, false>, subroutine_kind = 0 : i32, sym_name = "s14.get_coverage", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
              ...
              obelisk.sv.symbol.formal_argument attributes {direction = 3 : i32, hierarchical_name = "covergroup_unsupported.cg.get_coverage.total_bins", name = "total_bins", node_id = 21 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, sym_name = "s16.total_bins"} {
            ...
            obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.get_inst_coverage", is_builtin, name = "get_inst_coverage", node_id = 23 : i64, semantic_type = !obelisk.subroutine<(!obelisk.integral<32, true, false, 31 : 0, int>, !obelisk.integral<32, true, false, 31 : 0, int>) -> !obelisk.real, false>, subroutine_kind = 0 : i32, sym_name = "s17.get_inst_coverage", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
              obelisk.sv.statement.list attributes {node_id = 24 : i64} {
              }
              obelisk.sv.symbol.formal_argument attributes {direction = 3 : i32, hierarchical_name = "covergroup_unsupported.cg.get_inst_coverage.covered_bins", name = "covered_bins", node_id = 25 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, sym_name = "s18.covered_bins"} {
              ...
              obelisk.sv.symbol.formal_argument attributes {direction = 3 : i32, hierarchical_name = "covergroup_unsupported.cg.get_inst_coverage.total_bins", name = "total_bins", node_id = 27 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, sym_name = "s19.total_bins"} {
            ...
            obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.start", is_builtin, name = "start", node_id = 29 : i64, semantic_type = !obelisk.subroutine<() -> !obelisk.void, false>, subroutine_kind = 0 : i32, sym_name = "s20.start", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
              obelisk.sv.statement.list attributes {node_id = 30 : i64} {
              }
            }
            obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.stop", is_builtin, name = "stop", node_id = 31 : i64, semantic_type = !obelisk.subroutine<() -> !obelisk.void, false>, subroutine_kind = 0 : i32, sym_name = "s21.stop", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
              obelisk.sv.statement.list attributes {node_id = 32 : i64} {
              }
            }
            obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.sample", is_builtin, name = "sample", node_id = 33 : i64, semantic_type = !obelisk.subroutine<() -> !obelisk.void, false>, subroutine_kind = 0 : i32, sym_name = "s22.sample", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
              obelisk.sv.statement.list attributes {node_id = 34 : i64} {
              }
            }
            obelisk.sv.symbol.coverpoint attributes {has_iff = false, hierarchical_name = "covergroup_unsupported.cg.cp", name = "cp", node_id = 35 : i64, option_count = 0 : i64, semantic_type = !obelisk.ranged_packed_array<31 : 0 x !obelisk.integral<1, true, true, 0 : 0, logic>>, sym_name = "s23.cp"} {
              ...
              obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.cp.get_coverage", is_builtin, is_static, name = "get_coverage", node_id = 40 : i64, semantic_type = !obelisk.subroutine<(!obelisk.integral<32, true, false, 31 : 0, int>, !obelisk.integral<32, true, false, 31 : 0, int>) -> !obelisk.real, false>, subroutine_kind = 0 : i32, sym_name = "s26.get_coverage", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
                ...
                obelisk.sv.symbol.formal_argument attributes {direction = 3 : i32, hierarchical_name = "covergroup_unsupported.cg.cp.get_coverage.covered_bins", name = "covered_bins", node_id = 42 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, sym_name = "s27.covered_bins"} {
                ...
                obelisk.sv.symbol.formal_argument attributes {direction = 3 : i32, hierarchical_name = "covergroup_unsupported.cg.cp.get_coverage.total_bins", name = "total_bins", node_id = 44 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, sym_name = "s28.total_bins"} {
              ...
              obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.cp.get_inst_coverage", is_builtin, name = "get_inst_coverage", node_id = 46 : i64, semantic_type = !obelisk.subroutine<(!obelisk.integral<32, true, false, 31 : 0, int>, !obelisk.integral<32, true, false, 31 : 0, int>) -> !obelisk.real, false>, subroutine_kind = 0 : i32, sym_name = "s29.get_inst_coverage", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
                ...
                obelisk.sv.symbol.formal_argument attributes {direction = 3 : i32, hierarchical_name = "covergroup_unsupported.cg.cp.get_inst_coverage.covered_bins", name = "covered_bins", node_id = 48 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, sym_name = "s30.covered_bins"} {
                ...
                obelisk.sv.symbol.formal_argument attributes {direction = 3 : i32, hierarchical_name = "covergroup_unsupported.cg.cp.get_inst_coverage.total_bins", name = "total_bins", node_id = 50 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, sym_name = "s31.total_bins"} {
              ...
              obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.cp.start", is_builtin, name = "start", node_id = 52 : i64, semantic_type = !obelisk.subroutine<() -> !obelisk.void, false>, subroutine_kind = 0 : i32, sym_name = "s32.start", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
                obelisk.sv.statement.list attributes {node_id = 53 : i64} {
                }
              }
              obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.cp.stop", is_builtin, name = "stop", node_id = 54 : i64, semantic_type = !obelisk.subroutine<() -> !obelisk.void, false>, subroutine_kind = 0 : i32, sym_name = "s33.stop", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
                obelisk.sv.statement.list attributes {node_id = 55 : i64} {
                }
              }
              obelisk.sv.symbol.coverage_bin attributes {bins_kind = 0 : i32, has_iff = false, has_number_of_bins = false, has_set_coverage = false, has_with = false, hierarchical_name = "covergroup_unsupported.cg.cp.one", is_array = false, is_default = false, is_default_sequence = false, is_wildcard = false, name = "one", node_id = 56 : i64, sym_name = "s34.one", transition_set_count = 0 : i64, value_count = 1 : i64} {
...
// CHECK: coverage events and automatic sampling are not supported
