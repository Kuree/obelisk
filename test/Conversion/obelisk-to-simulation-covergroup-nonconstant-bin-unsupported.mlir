            ...
            obelisk.sv.symbol.coverpoint attributes {has_iff = false, hierarchical_name = "covergroup_unsupported.cg.cp", name = "cp", node_id = 33 : i64, option_count = 0 : i64, semantic_type = !obelisk.ranged_packed_array<31 : 0 x !obelisk.integral<1, true, true, 0 : 0, logic>>, sym_name = "s23.cp"} {
              ...
              obelisk.sv.symbol.coverage_bin attributes {bins_kind = 0 : i32, has_iff = false, has_number_of_bins = false, has_set_coverage = false, has_with = false, hierarchical_name = "covergroup_unsupported.cg.cp.dynamic", is_array = false, is_default = false, is_default_sequence = false, is_wildcard = false, name = "dynamic", node_id = 54 : i64, sym_name = "s34.dynamic", transition_set_count = 0 : i64, value_count = 1 : i64} {
                obelisk.sv.expression.conversion attributes {node_id = 55 : i64, semantic_type = !obelisk.ranged_packed_array<31 : 0 x !obelisk.integral<1, true, true, 0 : 0, logic>>} {
                  obelisk.sv.expression.named_value attributes {node_id = 56 : i64, referenced_path = "covergroup_unsupported.source", referenced_symbol = @s1.$root::@s3.covergroup_unsupported::@s4.covergroup_unsupported::@s6.source, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                }
              }
            }
...
// CHECK: coverage bin values must be elaboration-time constants
