          ...
          obelisk.sv.constraint.list attributes {item_count = 1 : i64, node_id = 75 : i64} {
            obelisk.sv.constraint.expression attributes {is_soft = false, node_id = 76 : i64} {
              obelisk.sv.expression.inside attributes {is_signed = false, item_count = 1 : i64, node_id = 77 : i64, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 78 : i64, referenced_path = "middle::limit", referenced_symbol = @s1.$root::@s2::@s47.middle::@s48.limit, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                }
                obelisk.sv.expression.value_range attributes {is_signed = false, node_id = 79 : i64, range_kind = 0 : i32, semantic_type = !obelisk.void} {
                  ...
                  obelisk.sv.expression.integer_literal attributes {constant_value = "9", is_declared_unsized = true, is_signed = true, node_id = 81 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                }
              }
            }
