          ...
          obelisk.sv.statement.concurrent_assertion attributes {assertion_kind = 5 : i32, has_default_disable = false, has_fail_action = false, has_pass_action = false, node_id = 11 : i64} {
            obelisk.sv.assertion.clocking attributes {node_id = 12 : i64} {
              ...
              obelisk.sv.assertion.binary attributes {node_id = 15 : i64, operator_kind = 1 : i32} {
                obelisk.sv.assertion.unary attributes {has_range = false, node_id = 16 : i64, operator_kind = 1 : i32, range_is_unbounded = false} {
                ...
                obelisk.sv.assertion.unary attributes {has_range = false, node_id = 19 : i64, operator_kind = 2 : i32, range_is_unbounded = false} {
                  obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 20 : i64, repetition_is_unbounded = false} {
                    obelisk.sv.expression.named_value attributes {node_id = 21 : i64, referenced_path = "top.a", referenced_symbol = @s1.$root::@s3.top::@s4.top::@s6.a, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                    }
                  }
                }
              }
...
// CHECK: expect over bounded temporal property operators currently requires one uniform weak or strong completion rule composed from direct operators; mixed or phase-sensitive intrinsic strength requires per-progress end-of-simulation state
