...
// Temporal negation and disable iff compose with all four temporal pair words.
// Disable clears matched history plus every pair and advances the report epoch;
          ...
          obelisk.sv.statement.concurrent_assertion attributes {assertion_kind = 2 : i32, has_default_disable = false, has_fail_action = false, has_pass_action = true, node_id = 20 : i64} {
            obelisk.sv.assertion.clocking attributes {node_id = 21 : i64} {
              obelisk.sv.timing.signal_event attributes {edge_kind = 1 : i32, has_iff = false, node_id = 22 : i64} {
                obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 23 : i64, referenced_path = "combined_temporal_not_disable.clk", referenced_symbol = @s1.$root::@s3.combined_temporal_not_disable::@s4.combined_temporal_not_disable::@s6.clk, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                }
              }
              obelisk.sv.assertion.disable_iff attributes {node_id = 24 : i64} {
                obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 25 : i64, referenced_path = "combined_temporal_not_disable.reset", referenced_symbol = @s1.$root::@s3.combined_temporal_not_disable::@s4.combined_temporal_not_disable::@s8.reset, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                }
                obelisk.sv.assertion.unary attributes {has_range = false, node_id = 26 : i64, operator_kind = 0 : i32, range_is_unbounded = false} {
                  obelisk.sv.assertion.binary attributes {node_id = 27 : i64, operator_kind = 11 : i32} {
                    obelisk.sv.assertion.binary attributes {node_id = 28 : i64, operator_kind = 1 : i32} {
                      obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 29 : i64, repetition_is_unbounded = false} {
                        obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 30 : i64, referenced_path = "combined_temporal_not_disable.a", referenced_symbol = @s1.$root::@s3.combined_temporal_not_disable::@s4.combined_temporal_not_disable::@s10.a, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                        }
                      }
                      obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 31 : i64, repetition_is_unbounded = false} {
                        obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 32 : i64, referenced_path = "combined_temporal_not_disable.b", referenced_symbol = @s1.$root::@s3.combined_temporal_not_disable::@s4.combined_temporal_not_disable::@s12.b, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                        }
                      }
                    }
                    obelisk.sv.assertion.binary attributes {node_id = 33 : i64, operator_kind = 1 : i32} {
                      obelisk.sv.assertion.sequence_concat attributes {delays = [{is_unbounded = false, max = 0 : i64, min = 0 : i64}, {is_unbounded = false, max = 1 : i64, min = 1 : i64}], node_id = 34 : i64} {
                        obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 35 : i64, repetition_is_unbounded = false} {
                          obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 36 : i64, referenced_path = "combined_temporal_not_disable.c", referenced_symbol = @s1.$root::@s3.combined_temporal_not_disable::@s4.combined_temporal_not_disable::@s14.c, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                          }
                        }
                        obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 37 : i64, repetition_is_unbounded = false} {
                          obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 38 : i64, referenced_path = "combined_temporal_not_disable.d", referenced_symbol = @s1.$root::@s3.combined_temporal_not_disable::@s4.combined_temporal_not_disable::@s16.d, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                          }
                        }
                      }
                      obelisk.sv.assertion.sequence_concat attributes {delays = [{is_unbounded = false, max = 0 : i64, min = 0 : i64}, {is_unbounded = false, max = 2 : i64, min = 2 : i64}], node_id = 39 : i64} {
                        obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 40 : i64, repetition_is_unbounded = false} {
                          obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 41 : i64, referenced_path = "combined_temporal_not_disable.c", referenced_symbol = @s1.$root::@s3.combined_temporal_not_disable::@s4.combined_temporal_not_disable::@s14.c, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                          }
                        }
                        obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 42 : i64, repetition_is_unbounded = false} {
                          obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 43 : i64, referenced_path = "combined_temporal_not_disable.e", referenced_symbol = @s1.$root::@s3.combined_temporal_not_disable::@s4.combined_temporal_not_disable::@s18.e, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                          }
                        }
                      }
                    }
            ...
            obelisk.sv.statement.expression_statement attributes {node_id = 44 : i64} {
              obelisk.sv.expression.call attributes {argument_count = 1 : i64, callee_name = "$display", constraint_restrictions = [], defaulted_arguments = array<i64: 0>, has_inline_constraints = false, has_iterator_expression = false, has_output_arguments = false, has_this_class = false, is_signed = false, is_super_class = false, is_system_call = true, node_id = 45 : i64, semantic_type = !obelisk.void, subroutine_kind = 1 : i32, system_library_cell = "work.combined_temporal_not_disable", system_scope_path = "combined_temporal_not_disable", system_scope_symbol = @s1.$root::@s3.combined_temporal_not_disable::@s4.combined_temporal_not_disable} {
                obelisk.sv.expression.string_literal attributes {constant_value = "hit", is_signed = false, node_id = 46 : i64, semantic_type = !obelisk.ranged_packed_array<23 : 0 x !obelisk.integral<1, false, false, 0 : 0, bit>>} {
                }
              }
            }
          }
