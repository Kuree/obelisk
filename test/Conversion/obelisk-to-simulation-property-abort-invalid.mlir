...
// CHECK: error: SVA property operator 'accept_on' requires asynchronous attempt completion, which is not executable yet; sampled sync_accept_on and sync_reject_on are supported for plain deterministic bounded properties
