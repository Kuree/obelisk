...
// RUN: sed '/symbol.procedural_block/s/procedure_kind = 0/procedure_kind = 3/' %s | obelisk-opt '--lower-obelisk-to-sim=opt-level=0' | FileCheck %s --check-prefix=SENS
            ...
            obelisk.sv.symbol.subroutine attributes {default_lifetime = 1 : i32, hierarchical_name = "top.a.get", name = "get", node_id = 9 : i64, return_variable_path = "top.a.get.get", return_variable_symbol = @s2.$root::@s4.top::@s5.top::@s6.a::@s7.bus_if::@s9.get::@s11.get, semantic_type = !obelisk.subroutine<(!obelisk.integral<32, true, false, 31 : 0, int>) -> !obelisk.integral<32, true, false, 31 : 0, int>, false>, subroutine_kind = 0 : i32, sym_name = "s9.get", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
              obelisk.sv.statement.return attributes {node_id = 10 : i64} {
                obelisk.sv.expression.binary_op attributes {is_signed = true, node_id = 11 : i64, operator_kind = 0 : i32, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  ...
                  obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 13 : i64, referenced_path = "top.a.get.add", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s6.a::@s7.bus_if::@s9.get::@s10.add, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                }
              }
              ...
              obelisk.sv.statement.list attributes {node_id = 17 : i64} {
                obelisk.sv.statement.expression_statement attributes {node_id = 18 : i64} {
                  obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, is_signed = true, node_id = 19 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 20 : i64, referenced_path = "top.a.put.old", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s6.a::@s7.bus_if::@s12.put::@s14.old, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                    obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 21 : i64, referenced_path = "top.a.x", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s6.a::@s7.bus_if::@s8.x, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                  }
                }
                obelisk.sv.statement.expression_statement attributes {node_id = 22 : i64} {
                  obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, is_signed = true, node_id = 23 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 24 : i64, referenced_path = "top.a.x", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s6.a::@s7.bus_if::@s8.x, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                    obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 25 : i64, referenced_path = "top.a.put.v", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s6.a::@s7.bus_if::@s12.put::@s13.v, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                  }
                }
              }
            ...
            obelisk.sv.symbol.subroutine attributes {default_lifetime = 1 : i32, hierarchical_name = "top.b.get", name = "get", node_id = 37 : i64, return_variable_path = "top.b.get.get", return_variable_symbol = @s2.$root::@s4.top::@s5.top::@s21.b::@s22.bus_if::@s24.get::@s26.get, semantic_type = !obelisk.subroutine<(!obelisk.integral<32, true, false, 31 : 0, int>) -> !obelisk.integral<32, true, false, 31 : 0, int>, false>, subroutine_kind = 0 : i32, sym_name = "s24.get", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
              obelisk.sv.statement.return attributes {node_id = 38 : i64} {
                obelisk.sv.expression.binary_op attributes {is_signed = true, node_id = 39 : i64, operator_kind = 0 : i32, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  ...
                  obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 41 : i64, referenced_path = "top.b.get.add", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s21.b::@s22.bus_if::@s24.get::@s25.add, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                }
              }
              ...
              obelisk.sv.statement.list attributes {node_id = 45 : i64} {
                obelisk.sv.statement.expression_statement attributes {node_id = 46 : i64} {
                  obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, is_signed = true, node_id = 47 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 48 : i64, referenced_path = "top.b.put.old", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s21.b::@s22.bus_if::@s27.put::@s29.old, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                    obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 49 : i64, referenced_path = "top.b.x", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s21.b::@s22.bus_if::@s23.x, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                  }
                }
                obelisk.sv.statement.expression_statement attributes {node_id = 50 : i64} {
                  obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, is_signed = true, node_id = 51 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 52 : i64, referenced_path = "top.b.x", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s21.b::@s22.bus_if::@s23.x, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                    obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 53 : i64, referenced_path = "top.b.put.v", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s21.b::@s22.bus_if::@s27.put::@s28.v, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                  }
                }
              }
          ...
          obelisk.sv.statement.block attributes {node_id = 65 : i64} {
            obelisk.sv.statement.list attributes {node_id = 66 : i64} {
              obelisk.sv.statement.expression_statement attributes {node_id = 67 : i64} {
                obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, is_signed = false, node_id = 68 : i64, semantic_type = !obelisk.virtual_interface<@s2.$root::@s5.top::@s6.a, "master">} {
                  obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 69 : i64, referenced_path = "top.vif", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s36.vif, semantic_type = !obelisk.virtual_interface<@s2.$root::@s5.top::@s6.a, "master">} {
                  }
                  obelisk.sv.expression.conversion attributes {is_signed = false, node_id = 70 : i64, semantic_type = !obelisk.virtual_interface<@s2.$root::@s5.top::@s6.a, "master">} {
                    obelisk.sv.expression.arbitrary_symbol attributes {is_signed = false, node_id = 71 : i64, referenced_path = "top.a", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s6.a, semantic_type = !obelisk.virtual_interface<@s2.$root::@s5.top::@s6.a, "">} {
                    }
                  }
                }
              }
              obelisk.sv.statement.expression_statement attributes {node_id = 72 : i64} {
                obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, is_signed = true, node_id = 73 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 74 : i64, referenced_path = "top.y", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s37.y, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                  obelisk.sv.expression.call attributes {virtual_interface_call_import, virtual_interface_call_modport = "master", argument_count = 1 : i64, callee_name = "get", constraint_restrictions = [], defaulted_arguments = array<i64: 0>, has_inline_constraints = false, has_iterator_expression = false, has_output_arguments = false, has_this_class = true, is_signed = true, is_super_class = false, is_system_call = false, node_id = 75 : i64, referenced_path = "top.bus_if.get", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s39.bus_if::@s41.get, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, subroutine_kind = 0 : i32} {
                    obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 76 : i64, referenced_path = "top.vif", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s36.vif, semantic_type = !obelisk.virtual_interface<@s2.$root::@s5.top::@s6.a, "master">} {
                    }
                    obelisk.sv.expression.integer_literal attributes {constant_value = "3", is_declared_unsized = true, is_signed = true, node_id = 77 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                  }
                }
              }
              obelisk.sv.statement.expression_statement attributes {node_id = 78 : i64} {
                obelisk.sv.expression.call attributes {virtual_interface_call_import, virtual_interface_call_modport = "master", argument_count = 2 : i64, callee_name = "put", constraint_restrictions = [], defaulted_arguments = array<i64: 0, 0>, has_inline_constraints = false, has_iterator_expression = false, has_output_arguments = true, has_this_class = true, is_signed = false, is_super_class = false, is_system_call = false, node_id = 79 : i64, referenced_path = "top.bus_if.put", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s39.bus_if::@s44.put, semantic_type = !obelisk.void, subroutine_kind = 1 : i32} {
                  obelisk.sv.expression.named_value attributes {is_signed = false, node_id = 80 : i64, referenced_path = "top.vif", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s36.vif, semantic_type = !obelisk.virtual_interface<@s2.$root::@s5.top::@s6.a, "master">} {
                  }
                  obelisk.sv.expression.integer_literal attributes {constant_value = "4", is_declared_unsized = true, is_signed = true, node_id = 81 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                  obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, is_signed = true, node_id = 82 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 83 : i64, referenced_path = "top.y", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s37.y, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                    obelisk.sv.expression.empty_argument attributes {is_signed = true, node_id = 84 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                    }
                  }
                }
              }
          ...
          obelisk.sv.symbol.subroutine attributes {default_lifetime = 1 : i32, hierarchical_name = "top.bus_if.get", name = "get", node_id = 87 : i64, return_variable_path = "top.bus_if.get.get", return_variable_symbol = @s2.$root::@s4.top::@s5.top::@s39.bus_if::@s41.get::@s43.get, semantic_type = !obelisk.subroutine<(!obelisk.integral<32, true, false, 31 : 0, int>) -> !obelisk.integral<32, true, false, 31 : 0, int>, false>, subroutine_kind = 0 : i32, sym_name = "s41.get", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
            obelisk.sv.statement.return attributes {node_id = 88 : i64} {
              obelisk.sv.expression.binary_op attributes {is_signed = true, node_id = 89 : i64, operator_kind = 0 : i32, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                ...
                obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 91 : i64, referenced_path = "top.bus_if.get.add", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s39.bus_if::@s41.get::@s42.add, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                }
              }
            }
            ...
            obelisk.sv.statement.list attributes {node_id = 95 : i64} {
              obelisk.sv.statement.expression_statement attributes {node_id = 96 : i64} {
                obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, is_signed = true, node_id = 97 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 98 : i64, referenced_path = "top.bus_if.put.old", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s39.bus_if::@s44.put::@s46.old, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                  obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 99 : i64, referenced_path = "top.bus_if.x", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s39.bus_if::@s40.x, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                }
              }
              obelisk.sv.statement.expression_statement attributes {node_id = 100 : i64} {
                obelisk.sv.expression.assignment attributes {assignment_kind = 0 : i32, is_signed = true, node_id = 101 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 102 : i64, referenced_path = "top.bus_if.x", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s39.bus_if::@s40.x, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                  obelisk.sv.expression.named_value attributes {is_signed = true, node_id = 103 : i64, referenced_path = "top.bus_if.put.v", referenced_symbol = @s2.$root::@s4.top::@s5.top::@s39.bus_if::@s44.put::@s45.v, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>} {
                  }
                }
              }
            }
...
// conservatively included in always_comb sensitivity.
// SENS: obelisk_sim.suspend.any {{.*}} edges [0, 0, 0, 0]
// MODPORT: virtual-interface method is not imported by the selected modport
