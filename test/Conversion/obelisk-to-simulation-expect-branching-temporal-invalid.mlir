...
// CHECK: branching bounded sequences currently require a concurrent directive without locals or implication, or an expect statement over one-cycle Boolean alternatives
