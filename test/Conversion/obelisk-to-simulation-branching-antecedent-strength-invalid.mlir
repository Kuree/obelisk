// RUN: %split-file %s %t
// RUN: not obelisk-opt %t/nested.mlir '--lower-obelisk-to-sim=opt-level=0' -o /dev/null 2>&1 | FileCheck %s --check-prefix=STRENGTH
// RUN: not obelisk-opt %t/composed.mlir '--lower-obelisk-to-sim=opt-level=0' -o /dev/null 2>&1 | FileCheck %s --check-prefix=STRENGTH
// RUN: not obelisk-opt %t/and-composed.mlir '--lower-obelisk-to-sim=opt-level=0' -o /dev/null 2>&1 | FileCheck %s --check-prefix=STRENGTH

// STRENGTH: error: branching implication/followed-by consequents with intrinsic temporal strength currently require one outermost bounded nexttime/always/eventually operator over one one-cycle Boolean operand; nested or composed strength requires per-phase end-of-simulation completion
          ...
          obelisk.sv.statement.concurrent_assertion attributes {assertion_kind = 0 : i32, has_default_disable = false, has_fail_action = false, has_pass_action = false, node_id = 10 : i64} {
            obelisk.sv.assertion.clocking attributes {node_id = 11 : i64} {
              ...
              obelisk.sv.assertion.binary attributes {node_id = 14 : i64, operator_kind = 11 : i32} {
                ...
                obelisk.sv.assertion.unary attributes {has_range = false, node_id = 20 : i64, operator_kind = 1 : i32, range_is_unbounded = false} {
                  obelisk.sv.assertion.unary attributes {has_range = false, node_id = 21 : i64, operator_kind = 2 : i32, range_is_unbounded = false} {
    ...
    obelisk.sv.symbol.instance attributes {hierarchical_name = "top", is_uninstantiated = false, name = "top", node_id = 3 : i64, referenced_path = "top", referenced_symbol = @s0.top, sym_name = "s3.top"} {
      obelisk.sv.symbol.instance_body attributes {hierarchical_name = "top", name = "top", node_id = 4 : i64, sym_name = "s4.top"} {
        ...
        obelisk.sv.symbol.procedural_block attributes {hierarchical_name = "top", node_id = 9 : i64, procedure_kind = 2 : i32, sym_name = "s9", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
          ...
          obelisk.sv.statement.concurrent_assertion attributes {assertion_kind = 2 : i32, has_default_disable = false, has_fail_action = false, has_pass_action = false, node_id = 10 : i64} {
            obelisk.sv.assertion.clocking attributes {node_id = 11 : i64} {
              obelisk.sv.timing.signal_event attributes {edge_kind = 1 : i32, has_iff = false, node_id = 12 : i64} {
                obelisk.sv.expression.named_value attributes {node_id = 13 : i64, referenced_path = "top.clk", referenced_symbol = @s1.$root::@s3.top::@s4.top::@s5.clk, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                }
              ...
              obelisk.sv.assertion.binary attributes {node_id = 14 : i64, operator_kind = 11 : i32} {
                ...
                obelisk.sv.assertion.binary attributes {node_id = 20 : i64, operator_kind = 0 : i32} {
                  obelisk.sv.assertion.unary attributes {has_range = false, node_id = 21 : i64, operator_kind = 1 : i32, range_is_unbounded = false} {
                    obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 22 : i64, repetition_is_unbounded = false} {
                      obelisk.sv.expression.named_value attributes {node_id = 23 : i64, referenced_path = "top.c", referenced_symbol = @s1.$root::@s3.top::@s4.top::@s8.c, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                      }
                    }
    ...
    obelisk.sv.symbol.instance attributes {hierarchical_name = "top", is_uninstantiated = false, name = "top", node_id = 3 : i64, referenced_path = "top", referenced_symbol = @s0.top, sym_name = "s3.top"} {
      obelisk.sv.symbol.instance_body attributes {hierarchical_name = "top", name = "top", node_id = 4 : i64, sym_name = "s4.top"} {
        ...
        obelisk.sv.symbol.procedural_block attributes {hierarchical_name = "top", node_id = 8 : i64, procedure_kind = 2 : i32, sym_name = "s8", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
          // (a or b) |=> (nexttime[0] a or nexttime[0] b) has one-cycle
          // Boolean alternatives, but replacing them with an unqualified
          // placeholder would lose the weak nexttime completion rule on the
          // nonoverlap handoff.
          obelisk.sv.statement.concurrent_assertion attributes {assertion_kind = 2 : i32, has_default_disable = false, has_fail_action = false, has_pass_action = false, node_id = 9 : i64} {
            obelisk.sv.assertion.clocking attributes {node_id = 10 : i64} {
              ...
              obelisk.sv.assertion.binary attributes {node_id = 13 : i64, operator_kind = 12 : i32} {
                obelisk.sv.assertion.binary attributes {node_id = 14 : i64, operator_kind = 1 : i32} {
                  ...
                  obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 17 : i64, repetition_is_unbounded = false} {
                    obelisk.sv.expression.named_value attributes {node_id = 18 : i64, referenced_path = "top.b", referenced_symbol = @s1.$root::@s3.top::@s4.top::@s7.b, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                    }
                  }
                }
                obelisk.sv.assertion.binary attributes {node_id = 19 : i64, operator_kind = 1 : i32} {
                  obelisk.sv.assertion.unary attributes {has_range = true, node_id = 20 : i64, operator_kind = 1 : i32, range_is_unbounded = false, range_max = 0 : i64, range_min = 0 : i64} {
                  ...
                  obelisk.sv.assertion.unary attributes {has_range = true, node_id = 23 : i64, operator_kind = 1 : i32, range_is_unbounded = false, range_max = 0 : i64, range_min = 0 : i64} {
                    obelisk.sv.assertion.simple attributes {has_repetition = false, is_null = false, node_id = 24 : i64, repetition_is_unbounded = false} {
                      obelisk.sv.expression.named_value attributes {node_id = 25 : i64, referenced_path = "top.b", referenced_symbol = @s1.$root::@s3.top::@s4.top::@s7.b, semantic_type = !obelisk.integral<1, false, true, 0 : 0, logic>} {
                      }
                    }
                  }
                }
