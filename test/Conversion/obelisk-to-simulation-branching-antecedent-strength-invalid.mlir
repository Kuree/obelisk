...
// STRENGTH: error: branching implication/followed-by consequents with mixed or phase-sensitive intrinsic temporal strength require per-progress end-of-simulation completion metadata
