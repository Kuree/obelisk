        ...
        obelisk.sv.type.covergroup_type attributes {constructor_argument_count = 0 : i64, has_coverage_event = false, hierarchical_name = "covergroup_unsupported.cg", name = "cg", node_id = 8 : i64, sample_formal_count = 0 : i64, semantic_type = !obelisk.covergroup_handle<@s1.$root::@s4.covergroup_unsupported::@s8.cg>, sym_name = "s8.cg"} {
          obelisk.sv.symbol.covergroup_body attributes {hierarchical_name = "covergroup_unsupported.cg", node_id = 9 : i64, option_count = 0 : i64, sym_name = "s9"} {
            ...
            obelisk.sv.symbol.coverpoint attributes {has_iff = false, hierarchical_name = "covergroup_unsupported.cg.cp", name = "cp", node_id = 33 : i64, option_count = 0 : i64, semantic_type = !obelisk.real, sym_name = "s23.cp"} {
              ...
              obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.cp.get_inst_coverage", is_builtin, name = "get_inst_coverage", node_id = 43 : i64, semantic_type = !obelisk.subroutine<(!obelisk.integral<32, true, false, 31 : 0, int>, !obelisk.integral<32, true, false, 31 : 0, int>) -> !obelisk.real, false>, subroutine_kind = 0 : i32, sym_name = "s29.get_inst_coverage", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
                obelisk.sv.statement.list attributes {node_id = 44 : i64} {
                }
                obelisk.sv.symbol.formal_argument attributes {direction = 3 : i32, hierarchical_name = "covergroup_unsupported.cg.cp.get_inst_coverage.covered_bins", name = "covered_bins", node_id = 45 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, sym_name = "s30.covered_bins"} {
                ...
                obelisk.sv.symbol.formal_argument attributes {direction = 3 : i32, hierarchical_name = "covergroup_unsupported.cg.cp.get_inst_coverage.total_bins", name = "total_bins", node_id = 47 : i64, semantic_type = !obelisk.integral<32, true, false, 31 : 0, int>, sym_name = "s31.total_bins"} {
              ...
              obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.cp.start", is_builtin, name = "start", node_id = 49 : i64, semantic_type = !obelisk.subroutine<() -> !obelisk.void, false>, subroutine_kind = 0 : i32, sym_name = "s32.start", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
                obelisk.sv.statement.list attributes {node_id = 50 : i64} {
                }
              }
              obelisk.sv.symbol.subroutine attributes {hierarchical_name = "covergroup_unsupported.cg.cp.stop", is_builtin, name = "stop", node_id = 51 : i64, semantic_type = !obelisk.subroutine<() -> !obelisk.void, false>, subroutine_kind = 0 : i32, sym_name = "s33.stop", time_precision_fs = 1000000 : i64, time_unit_fs = 1000000 : i64} {
                obelisk.sv.statement.list attributes {node_id = 52 : i64} {
                }
              }
              obelisk.sv.symbol.coverage_bin attributes {bins_kind = 0 : i32, has_iff = false, has_number_of_bins = false, has_set_coverage = false, has_with = false, hierarchical_name = "covergroup_unsupported.cg.cp.zero", is_array = false, is_default = false, is_default_sequence = false, is_wildcard = false, name = "zero", node_id = 53 : i64, sym_name = "s34.zero", transition_set_count = 0 : i64, value_count = 1 : i64} {
                obelisk.sv.expression.conversion attributes {node_id = 54 : i64, semantic_type = !obelisk.real} {
...
// CHECK: coverpoint expressions must have a two-state or four-state integral type
