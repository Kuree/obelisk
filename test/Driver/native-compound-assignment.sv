// RUN: obelisk --std=1800-2023 -Wno-nonstandard-string-concat -O0 %s -o %t.o0.native
// RUN: %t.o0.native > %t.o0.native.out
// RUN: FileCheck %s < %t.o0.native.out
// RUN: obelisk --std=1800-2023 -Wno-nonstandard-string-concat -O0 --execution-tier=bytecode %s -o %t.o0.bytecode
// RUN: %t.o0.bytecode > %t.o0.bytecode.out
// RUN: diff -u %t.o0.native.out %t.o0.bytecode.out
// RUN: obelisk --std=1800-2023 -Wno-nonstandard-string-concat -O3 %s -o %t.o3.native
// RUN: %t.o3.native > %t.o3.native.out
// RUN: diff -u %t.o0.native.out %t.o3.native.out
// RUN: obelisk --std=1800-2023 -Wno-nonstandard-string-concat -O3 --execution-tier=bytecode %s -o %t.o3.bytecode
